...
const galleryImages = [
  ...
  "https://t4.ftcdn.net/jpg/03/45/39/90/360_F_345399003_UHleelD6YkxqAjmnX8ZkPcm3vVUkQubq.jpg",
  "https://t4.ftcdn.net/jpg/05/68/49/00/360_F_568490007_q6JDpAc6VPnKD8cX0PIiF4UB91MNtA9S.jpg",
  "https://t4.ftcdn.net/jpg/03/03/15/58/360_F_303155889_LScTiSPmEJZKJZEnONZHP9WR1x7b5Fj9.jpg",
  "https://t4.ftcdn.net/jpg/03/38/92/21/360_F_338922186_ful8D4Nkpm3Ygr1UOrNGCrN1GNGa5JSz.jpg",
];
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        <div className="flex-[7] w-full max-w-full items-center relative">
          ...
          <div className="relative grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4 h-[320px] sm:h-[450px]">
            ...
            {/* Image 2 */}
            <div className="relative rounded-xl overflow-hidden shadow-lg hidden md:visible">
              <img
                src={galleryImages[1]}
                alt="Instagram 2"
                className="w-full h-full object-cover transition-transform duration-500 hover:scale-105"
              ...
              >
                {[...galleryImages, ...galleryImages.slice(0, 2)]
                  ...
                  .map((img, index) => (
                    <div
                      key={index}
                      className="w-20 sm:w-24 h-20 sm:h-24 flex-shrink-0 rounded-xl overflow-hidden shadow-lg border-2 sm:border-4 border-[#E2B63B] cursor-pointer"
            ...
            {/* Image 5 - Overlap top-right */}
            <div className="absolute right-2 hidden md:visible sm:right-6 top-2 sm:top-6 w-20 sm:w-24 h-20 sm:h-24 rounded-xl overflow-hidden shadow-lg z-20 border-2 sm:border-4 border-[#E2B63B]">
              <img
                src={galleryImages[4]}
                alt="Instagram 5"
                className="w-full h-full object-cover"
