...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_gqa0p5p", // EmailJS service ID
        "template_926hrpy", // EmailJS template ID
        formData,
        "w2s2HSZsye_VrjqXW" // EmailJS public key
      )
      .then(
        () => {
        ...
        <section className="relative pb-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-[#4B2E1E] max-w-3xl mx-auto">
              Get in touch with our team to book your consultation or ask any
              questions
            </p>
          </div>
        </section>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p>304 serenity square, Navrang six road, Navrangpura, Ahmedabad-380009</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p>mt.embrace.wellness@gmail.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-start space-x-4 mb-6 text-white">
                      ...
                      <a href="https://www.instagram.com/embrace.feel.alive?igsh=bTYwbWl1dnhmaXB2" className="hover:text-[var(--brown-yellow-bg)] transition-colors">
