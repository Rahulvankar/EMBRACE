...
const cardData = [
  {
    ...
    desc: "Personalized fitness and nutrition strategies to help you feel and look your best.",
    icon: <FaRunning size={22} />,
  },
  {
    title: "Cancer Rehabilitation",
    desc: "Specialized support to rebuild strength, mobility, and confidence after cancer treatment.",
    icon: <FaMedal size={22} />,
  },
  {
    title: "Pregnancy Care",
    desc: "Holistic prenatal programs supporting physical, emotional, and nutritional wellbeing.",
    icon: <FaChalkboardTeacher size={22} />,
  },
  {
    title: "Menopause Wellness",
    desc: "Empowering women with tools and guidance to thrive through menopause transitions.",
